          ...
          <section className="py-20 bg-white">
               <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                         {/* Map Column - Animat cu delay 0.2s */}
                         <motion.div
                              className="relative"
                              initial="hidden"
                              whileInView="visible"
                         ...
                         >
                              ...
                              <div className="hidden md:block absolute top-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow-md">
                         ...
                         {/* Attractions Column - Animat cu delay 0.4s */}
                         <motion.div
                              initial="hidden"
                              whileInView="visible"
                              viewport={{ once: true, amount: 0.1 }}
                         ...
                         >
                              <div>
                                   ...
                                   <div className="space-y-4">
                                        {attractions.map(
                                             (attraction, index) => (
                                                  <div
                                                       key={index}
                                                       className="bg-traian-cream rounded-lg p-4 hover:shadow-md transition-shadow border border-transparent hover:border-traian-gold/20"
                                                  >
                                   ...
                                   {/* Transport Info */}
                                   <div className="mt-8 p-6 bg-traian-burgundy/5 rounded-xl border border-traian-burgundy/10">
